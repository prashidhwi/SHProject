...
public class CustomerDao extends BaseJdbcDaoSupport {
	...
	public List<Customer> getCustomer() {
		...
		// customer.setSize(rs.getString(3));
		// customer.setColor(rs.getString(4));
		// customer.setQty(rs.getInt(5));
		// customer.setPrice(rs.getFloat(6));
		// customer.setSupplierId(rs.getInt(7));
		// customer.setInputDate(rs.getDate(8));
		// customer.setUpdateDate(rs.getDate(9));
		// return customer;
		// }
		// });
	}
